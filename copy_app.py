...
from re import A
from flask import Flask, jsonify, render_template, redirect, render_template_string
...
# def hello(username):
#   job=tasks.just_say_hello.apply_async(username)
#   result=job.wait()
...
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:///copy_of_testdb.sqlite3" 
...
#         user_datastore.create_user(email="test2@me.com", password=hash_password("password"))
#     db.session.commit()
...
def caheexample():
  ...
  return render_template_string(str(datetime.datetime.now()))
